        ...
        <div className="mt-12 grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="card">
            ...
            <div className="space-y-3">
              <Link to="/participants/register" className="block p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                <div className="font-medium text-gray-900">Register New Participant</div>
                <div className="text-sm text-gray-600">Start multi-step registration process</div>
              </Link>
              <Link to="/participants" className="block p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                <div className="font-medium text-gray-900">Add Points</div>
                <div className="text-sm text-gray-600">Search participant and add points</div>
              </Link>
              <Link to="/prizes" className="block p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                <div className="font-medium text-gray-900">Redeem Prize</div>
                <div className="text-sm text-gray-600">Help participant redeem rewards</div>
              </Link>
            </div>
          </div>
